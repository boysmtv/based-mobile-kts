...
class PreferenceConstants {
    ...
    object AppConfig {
        ...
        const val PREF_KEY_REGEX_BANK_NUMBER = "account.number.transfer.another.bank.regex"
        ...
        const val KEY_WMCORE = "wmcore.status"
    }
    ...
    object LovKey {
        ...
        const val PREF_KEY_CASH_WITHDRAWAL_MAX_MINIMUM_AMOUNT = "withdrawal.minimum.amount"
    }
